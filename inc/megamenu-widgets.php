 ...
 */
if ( ! class_exists('MMPlus_Widgets')) {
	class MMPlus_Widgets
	{
		
		function __construct() {
            add_action('init', array($this, 'mmplus_register_sidebar'));
		    add_action('wp_ajax_mmplus_reorder_items', array($this, 'mmplus_reorder_items'));
            add_action('wp_ajax_mmplus_save_widget', array($this, 'mmplus_save_widget'));
            add_action('wp_ajax_mmplus_drag_to_add_widget_item', array($this, 'mmplus_drag_to_add_widget_item'));

            add_action('wp_ajax_mmplus_delete_row', array($this, 'mmplus_delete_row'));
            add_action('wp_ajax_mmplus_delete_column', array($this, 'mmplus_delete_column'));
            add_action('wp_ajax_mmplus_delete_widget', array($this, 'mmplus_delete_widget'));
            add_action('wp_ajax_mmplus_reorder_row', array($this, 'mmplus_reorder_row'));
            add_action('wp_ajax_mmplus_reorder_col', array($this, 'mmplus_reorder_col'));
            add_action('wp_ajax_mmplus_add_grid_row_column', array($this, 'mmplus_add_grid_row_column'));
		}

	 /**
     * @return MMPlus_Widgets
     */
         ...
         */
        public function mmplus_register_sidebar() {
            register_sidebar(
                array(
                    'id' => 'mmth',
         ...
         */
        public function mmplus_get_sidebar_widgets() {
         ...
         */
        private function mmplus_set_sidebar_widgets( $widgets_array ) {
         ...
         *
         */
        private function mmplus_add_widget_to_sidebar( $new_widget_id ) {
            $new_widgets = $this->mmplus_get_sidebar_widgets();
            $new_widgets[] = $new_widget_id;
            $this->mmplus_set_sidebar_widgets($new_widgets);
       ...
       /**
         ...
         * Get base widget id
         */
        public function mmplus_get_id_base_for_widget_id( $widget_id ) {
         ...
         * @return bool|string
         */
        public function mmplus_get_widget_class_by_widget_id( $widget_id ) {
            global $wp_registered_widget_controls;
	   ...
	   /**
	     ...
	     */
	     ...
	     public static function mmplus_menu_items( $menu_item, $widget_key_id = 0){
            ?>
         ...
         */
        public static function mmplus_widget_items($widget_id, $widget_key_id = 0){   
            global $wp_registered_widget_controls;   
            $control = $wp_registered_widget_controls[$widget_id];
            ...
            echo $widget_key_id; ?>">
                ...
                <div class="widget-inner widget-inside">
                    <form method='post'  class="mmplus_widget_save_form">
         ...
         * @return bool|string
         */
        public function mmplus_get_widget_name_by_widget_id( $widget_id ) {
            global $wp_registered_widget_controls;
         ...
         */
        public function mmplus_save_widget(){
	   ...
	   /**
	     ...
	     */
	    public static function mmplus_get_all_registered_widgets(){
         ...
         */
        public function mmplus_show_widget( $id ) {
            global $wp_registered_widgets;
            $params = array_merge(
                array( array_merge( array( 'widget_id' => $id, 'widget_name' => $wp_registered_widgets[$id]['name'] ) ) ),
                (array) $wp_registered_widgets[$id]['params']
            );
            $params[0]['before_title'] = apply_filters( "mmplus_before_widget_title", '<h4 class="mmplus-item-title">', $wp_registered_widgets[$id] );
            $params[0]['after_title'] = apply_filters( "mmplus_after_widget_title", '</h4>', $wp_registered_widgets[$id] );
            $params[0]['before_widget'] = apply_filters( "mmplus_before_widget", "", $wp_registered_widgets[$id] );
            $params[0]['after_widget'] = apply_filters( "mmplus_after_widget", "", $wp_registered_widgets[$id] );
         ...
         */
        public function mmplus_reorder_items(){
            ...
            $get_layout = get_post_meta($menu_item_id, 'mmplus_layout', true);
         ...
         * Delete Row
         */
        public function mmplus_delete_row(){
            check_ajax_referer( 'mmplus_check_security', 'mmplus_nonce' );

            $menu_item_id   = (int) sanitize_text_field($_POST['menu_item_id']);
            $row_id         = (int) sanitize_text_field($_POST['row_id']);
            $get_layout = maybe_unserialize(get_post_meta($menu_item_id, 'mmplus_layout', true));
         ...
         * Delete column
         */
        public function mmplus_delete_column(){
            check_ajax_referer( 'mmplus_check_security', 'mmplus_nonce' );
         ...
         */
        public function mmplus_reorder_row(){
         ...
         */
        public function mmplus_reorder_col(){
         ...
         */
        public function mmplus_drag_to_add_widget_item() {
            ...
            $this->mmplus_add_widget_to_sidebar($widget_id);
            ...
            $widget_name = $this->mmplus_get_widget_name_by_widget_id($widget_id);
            $widget_class = $this->mmplus_get_widget_class_by_widget_id($widget_id);
            $get_layout = maybe_unserialize(get_post_meta($menu_item_id, 'mmplus_layout', true));
        ...
        public function mmplus_add_grid_row_column() {
            check_ajax_referer( 'mmplus_check_security', 'mmplus_nonce' );
            $menu_item_id = (int) sanitize_text_field($_POST['menu_item_id']);
            ...
            $old_layout = (array) maybe_unserialize( get_post_meta($menu_item_id, 'mmplus_layout', true));
            ...
            update_post_meta($menu_item_id, 'mmplus_layout', $new_layout);
        ...
        public function mmplus_delete_widget(){
            check_ajax_referer( 'mmplus_check_security', 'mmplus_nonce' );
            ...
            $this->mmplus_delete_widget_from_sidebar( $widget_id );
            $this->mmplus_delete_widget_from_builder_column( $menu_item_id, $row_id, $col_id, $widget_key_id );
            $this->mmplus_delete_widget_from_widget_options_db( $id_base, $widget_id );

       }

        public function mmplus_delete_widget_from_sidebar( $widget_id ){
            //Remove from sidebar
            $sidebar_widgets = $this->mmplus_get_sidebar_widgets();
            $new_widgets = array();
        ...
        public function mmplus_delete_widget_from_builder_column( $menu_item_id, $row_id, $col_id, $widget_key_id ){
        ...
        public function mmplus_delete_widget_from_widget_options_db( $id_base, $widget_id ){
